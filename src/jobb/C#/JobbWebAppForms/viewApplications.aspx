<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="viewApplications.aspx.cs" Inherits="JobbWebAppForms.viewApplications" %>
            ...
            <tr>
                ...
                <td style="vertical-align:top;" class="auto-style2">
                    ...
                    <table border="0">
                        ...
                        <tr>
                            <td>
                                <a href="viewTowns.aspx"><asp:Label ID="labelTownID" runat="server" Text="StedID"></asp:Label></a>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td>
                                <a href="viewTowns.aspx"><asp:Label ID="labelTownName" runat="server" Text="Stedsnavn"></asp:Label></a>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td>
                                <a href="viewCountries.aspx"><asp:Label ID="labelCountryID" runat="server" Text="LandID"></asp:Label></a>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td>
                                <a href="viewCountries.aspx"><asp:Label ID="labelCountry" runat="server" Text="Landnavn"></asp:Label></a>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td>
                                <a href="viewStatuses.aspx"><asp:Label ID="labelStatusID" runat="server" Text="StatusID"></asp:Label></a>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td>
                                <a href="viewStatuses.aspx"><asp:Label ID="labelStatus" runat="server" Text="Status"></asp:Label></a>
                            </td>
                            <td>
