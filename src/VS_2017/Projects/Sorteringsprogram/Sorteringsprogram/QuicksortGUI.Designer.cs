namespace Sorteringsprogram
{
    partial class QuicksortGUI
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.label1.Text = "Her kan du sortere usorterte tall ved hjelp av hurtigsortering (quicksort). Last " +
    "inn filen med de usorterte (eller omvendt sorterte) tallene og klikk sorter for " +
    "å sortere dem.";
            // 
            // openFileDialog1
            // 
            ...
            this.Name = "QuicksortGUI";
            this.Text = "Quicksort";
            this.Load += new System.EventHandler(this.QuicksortGUI_Load);
