...
public:
    ...
    void setupUi(QDialog *connectPsql)
    {
        ...
        QWidget::setTabOrder(lineEdit_Host, lineEdit_User);
    ...
    {
        connectPsql->setWindowTitle(QApplication::translate("connectPsql", "Logg inn til PostgreSQL", nullptr));
        label_4->setText(QApplication::translate("connectPsql", "Skriv inn informasjonen som brukes under oppkoblingen. Kobler du til lokalt, bruk adressen 127.0.0.1.", nullptr));
        label->setText(QApplication::translate("connectPsql", "IP-adresse", nullptr));
        label_2->setText(QApplication::translate("connectPsql", "Brukernavn", nullptr));
        label_3->setText(QApplication::translate("connectPsql", "Passord", nullptr));
    } // retranslateUi
