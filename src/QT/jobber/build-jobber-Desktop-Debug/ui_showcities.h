...
public:
    ...
    void retranslateUi(QMainWindow *ShowCities)
    {
        ...
        btnSave->setText(QApplication::translate("ShowCities", "Lagre", Q_NULLPTR));
        ...
        btnDelete->setText(QApplication::translate("ShowCities", "Slett", Q_NULLPTR));
