...
public:
    ...
    void retranslateUi(QMainWindow *ViewJobs)
    {
        ...
        btnSave->setText(QApplication::translate("ViewJobs", "Lagre", Q_NULLPTR));
        btnDelete->setText(QApplication::translate("ViewJobs", "Slett", Q_NULLPTR));
        labelInfo->setText(QApplication::translate("ViewJobs", "Her kan du se informasjon om s\303\270knadene som er registrert i databasen. Felt markert med * m\303\245 fylles ut", Q_NULLPTR));
        labelMotivation->setText(QApplication::translate("ViewJobs", "Motivasjon", Q_NULLPTR));
    } // retranslateUi
