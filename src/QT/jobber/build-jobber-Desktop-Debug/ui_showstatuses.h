...
public:
    ...
    void setupUi(QMainWindow *ShowStatuses)
    {
        ...
        gridLayout->addWidget(labelStatusID, 1, 0, 1, 2);
        ...
        gridLayout->addWidget(lineEdit, 2, 2, 1, 3);
    ...
    {
        ShowStatuses->setWindowTitle(QApplication::translate("ShowStatuses", "Vis innlagte statuser", nullptr));
        labelInfo->setText(QApplication::translate("ShowStatuses", "Her kan du se de ulike statusene som er registrert i systemet. Vil du endre p\303\245 ID-en til en status, m\303\245 det gj\303\270res i kommandolinja. Alle felt m\303\245 utfylles.", nullptr));
        labelStatusID->setText(QApplication::translate("ShowStatuses", "StatusID*", nullptr));
        labelStatus->setText(QApplication::translate("ShowStatuses", "Status*", nullptr));
        btnFirst->setText(QApplication::translate("ShowStatuses", "<<", nullptr));
        btnPrev->setText(QApplication::translate("ShowStatuses", "<", nullptr));
        btnNext->setText(QApplication::translate("ShowStatuses", ">", nullptr));
        btnLast->setText(QApplication::translate("ShowStatuses", ">>", nullptr));
        btnSave->setText(QApplication::translate("ShowStatuses", "Lagre", nullptr));
        btnDelete->setText(QApplication::translate("ShowStatuses", "Slett", nullptr));
    } // retranslateUi
