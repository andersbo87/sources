...
public:
    ...
    {
        NewStatus->setWindowTitle(QApplication::translate("NewStatus", "Ny status", nullptr));
        labelInfo->setText(QApplication::translate("NewStatus", "Her kan du legge inn en ny status i databasen.", nullptr));
        labelStatusName->setText(QApplication::translate("NewStatus", "Status", nullptr));
    } // retranslateUi
