...
#include "../jobber/showcountries.h"
...
const QMetaObject ShowCountries::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_ShowCountries.data,
      qt_meta_data_ShowCountries,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ShowCountries::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ShowCountries.stringdata0))
        return static_cast<void*>(const_cast< ShowCountries*>(this));
