...
public:
    ...
    {
        ShowCountries->setWindowTitle(QApplication::translate("ShowCountries", "Vis innlagte land", Q_NULLPTR));
        ...
        btnSave->setText(QApplication::translate("ShowCountries", "Lagre", Q_NULLPTR));
        btnDelete->setText(QApplication::translate("ShowCountries", "Slett", Q_NULLPTR));
